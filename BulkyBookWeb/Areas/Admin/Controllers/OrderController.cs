    ...
    public class OrderController : Controller
    {
        ...
        public IActionResult Details(int orderId)
        {
            OrderVM = new OrderVM()
            {
                ...
                OrderDetail = _unitOfWork.OrderDetailsRepository.GetAll(u => u.OrderId == orderId, includeProperties: "Product"),
            };
            return View(OrderVM);
        }
        ...
        public IActionResult Details_PAY_NOW()
        {
            ...
            OrderVM.OrderDetail = _unitOfWork.OrderDetailsRepository.GetAll(u => u.OrderId == OrderVM.OrderHeader.Id, includeProperties: "Product");
